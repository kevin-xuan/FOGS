...
if __name__ == '__main__':
    ...
    output_pkl_filename = args.output_pkl_filename + '/' + 'learn_S08_{}_un_{}_di_16_mx.pkl'.format(args.thresh_T,
                                                                                                    args.thresh_cos)
    print(output_pkl_filename)

    if os.path.exists(args.filename_emb):
        print('Thresh_T is: ', args.thresh_T)
        print('Thresh_cos is: ', args.thresh_cos)
        learn_graph = learn_final_graph(args.thresh_cos, filename=args.filename_emb,
                                        direct=args.direct_L)  # learn graph
